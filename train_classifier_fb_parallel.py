...
def layers(inputs, params=None):
    ...
    pipe2 = Conv3D(96, (1,6,7), strides=(1,1,1), padding='valid')(inputs)
    pipe2 = BatchNormalization()(pipe2)
    pipe2 = LeakyReLU(alpha=0.05)(pipe2)
    pipe2 = Reshape((pipe2.shape[1].value, 96))(pipe2)
    pipe2 = AveragePooling1D(pool_size=(75), strides=(15))(pipe2)
    pipe2 = Dense(96)(pipe2)
    pipe2 = LeakyReLU(alpha=0.05)(pipe2)

    pipe = concatenate([pipe2, pipe1], axis=2)
