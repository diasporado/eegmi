...
def layers(inputs, params=None):
    ...
    '''
    pipe1 = GroupDepthwiseConv3D(kernel_size=(1,3,3), strides=(1,1,1), group_multiplier=256, padding='valid', group_size=1)(inputs)
    ...
    pipe1 = Reshape((pipe1.shape[1].value, 256, 9))(pipe1)
