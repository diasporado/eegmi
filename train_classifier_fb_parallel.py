...
def layers(inputs, params=None):
    ...
    pipe1 = DepthwiseConv3D(kernel_size=(1,3,3), strides=(1,1,1), group_multiplier=64, padding='valid')(pipe1)
    pipe1 = LeakyReLU(alpha=0.05)(pipe1)
    pipe1 = DepthwiseConv3D(kernel_size=(1,2,3), strides=(1,1,1), group_multiplier=64, padding='valid')(pipe1)
    pipe1 = LeakyReLU(alpha=0.05)(pipe1)
